...
func (x *ProductVariant) GetMaterial() string {
	if x != nil {
		return x.Material
	}
	return ""
...
func (x *ProductVariant) GetCostPrice() float32 {
	if x != nil {
		return x.CostPrice
	}
	return 0
...
func (x *ProductResponse) GetVariants() []*ProductVariant {
	if x != nil {
		return x.Variants
	}
	return nil
...
const file_product_service_proto_rawDesc = "" +
	...
	"\x05items\x18\x01 \x03(\v2\x12.product.StockItemR\x05items\"e\n" +
	"\tStockItem\x12\x1d\n" +
	"\n" +
	...
	"\x0eGetAllProducts\x12\x0e.product.Empty\x1a\x14.product.ProductListB\vZ\t./serviceb\x06proto3"
...
var file_product_service_proto_goTypes = []any{
	...
	(*StockUpdateStatus)(nil),    // 9: product.StockUpdateStatus
	(*Empty)(nil),                // 10: product.Empty
	(*Product)(nil),              // 11: product.Product
	(*ProductList)(nil),          // 12: product.ProductList
}
var file_product_service_proto_depIdxs = []int32{
	2,  // 0: product.ProductResponse.variants:type_name -> product.ProductVariant
	7,  // 1: product.UpdateStockRequest.items:type_name -> product.StockItem
	9,  // 2: product.UpdateStockResponse.update_status:type_name -> product.StockUpdateStatus
	11, // 3: product.ProductList.products:type_name -> product.Product
	0,  // 4: product.ProductService.GetBasicInfo:input_type -> product.ProductRequest
	0,  // 5: product.ProductService.GetProductInfo:input_type -> product.ProductRequest
	0,  // 6: product.ProductService.CheckStock:input_type -> product.ProductRequest
	6,  // 7: product.ProductService.UpdateStock:input_type -> product.UpdateStockRequest
	10, // 8: product.ProductService.GetAllProducts:input_type -> product.Empty
	1,  // 9: product.ProductService.GetBasicInfo:output_type -> product.BasicProductResponse
	3,  // 10: product.ProductService.GetProductInfo:output_type -> product.ProductResponse
	4,  // 11: product.ProductService.CheckStock:output_type -> product.StockResponse
	8,  // 12: product.ProductService.UpdateStock:output_type -> product.UpdateStockResponse
	12, // 13: product.ProductService.GetAllProducts:output_type -> product.ProductList
