...
type CartServiceClient interface {
	GetCartItems(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*CartResponse, error)
}
...
func (c *cartServiceClient) GetCartItems(ctx context.Context, in *CartRequest, opts ...grpc.CallOption) (*CartResponse, error) {
...
type CartServiceServer interface {
	GetCartItems(context.Context, *CartRequest) (*CartResponse, error)
...
func (UnimplementedCartServiceServer) GetCartItems(context.Context, *CartRequest) (*CartResponse, error) {
...
func _CartService_GetCartItems_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).GetCartItems(ctx, req.(*CartRequest))
	}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "module/gRPC-cart/cart_service.proto",
}
